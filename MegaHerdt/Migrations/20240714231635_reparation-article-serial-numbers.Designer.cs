...
namespace MegaHerdt.API.Migrations
{
    ...
    [Migration("20240714231635_reparation-article-serial-numbers")]
    partial class reparationarticleserialnumbers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MegaHerdt.Models.Models.Article", b =>
                {
                    ...
                    b.Property<DateTime?>("ArticleEditedDateTime")
                    ...
                    b.Property<DateTime?>("ProvisionCreatedDateTime")
                        .HasColumnType("datetime2");

                    b.Property<float?>("ProvisionPrice")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("MegaHerdt.Models.Models.ArticleProviderSerialNumber", b =>
                {
                    ...
                    b.Property<bool>("IsDiscountStockOperation")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MegaHerdt.Models.Models.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2d48c8be-4224-4f53-aa1e-8b910ef8229c",
                            CreatedDate = new DateTime(2024, 7, 14, 23, 16, 34, 854, DateTimeKind.Utc).AddTicks(8642),
                            Dni = "42464099",
                            ...
                            SecurityStamp = "28c18098-4854-42f6-9055-535ab724d787",
                            Surname = "Admin",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5e045f79-77f1-47ef-91d8-43ecc39d0d4c",
                            CreatedDate = new DateTime(2024, 7, 14, 23, 16, 34, 854, DateTimeKind.Utc).AddTicks(8656),
                            Dni = "45698746",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMfyNTA180vxZ2Log08brPlw6oav6rL7mDtMn2Dv22mlg+eRjRRRtNMSCA4aoAvyNA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "10096beb-019a-4642-89e4-b355abbfe75b",
                            Surname = "Zappa",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("MegaHerdt.Models.Models.ReparationArticleSerialNumber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ReparationArticleArticleId")
                        .HasColumnType("int");

                    b.Property<int>("ReparationArticleId")
                        .HasColumnType("int");

                    b.Property<int>("ReparationArticleReparationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReparationArticleArticleId", "ReparationArticleReparationId");

                    b.ToTable("ReparationsArticlesSerialNumbers");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "cf0207f6-cddb-4777-a1c5-d9367929cb66",
                            Name = "ADMIN",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "4b7f810b-75bf-4009-8dc7-9961a1182a1c",
                            Name = "EMPLEADO",
            ...
            modelBuilder.Entity("MegaHerdt.Models.Models.ReparationArticleSerialNumber", b =>
                {
                    b.HasOne("MegaHerdt.Models.Models.ReparationArticle", null)
                        .WithMany("SerialNumbers")
                        .HasForeignKey("ReparationArticleArticleId", "ReparationArticleReparationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
